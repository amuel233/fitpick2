                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    if isEditing {
                        ...
                        Button(action: {
                            ...
                            // Trigger the test analytics event
                                logTestPurchase()
...
func logTestPurchase() {
    // 1. Define the items being "purchased"
    let item: [String: Any] = [
        AnalyticsParameterItemID: "sku_profile_test",
        AnalyticsParameterItemName: "Profile Edit Test",
        AnalyticsParameterPrice: 0.99,
        AnalyticsParameterQuantity: 1
    ]

    // 2. Log the purchase event with required top-level parameters
    Analytics.logEvent(AnalyticsEventPurchase, parameters: [
        AnalyticsParameterTransactionID: "T12345", // Unique ID for testing
        AnalyticsParameterValue: 0.99,
        AnalyticsParameterCurrency: "USD",
        AnalyticsParameterItems: [item] // Must be an array
    ])
    
    print("✅ Test Purchase Logged to Firebase Analytics")
}
